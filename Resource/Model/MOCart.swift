...
class MOCart: NSObject {
    ...
    init(id: Int?,menu_category_id: String?,menu_item_id: String?,item_name: String? , descriptionOfMenu: String? , available: String?  , price :  String? , order_id : String? , quantity : String?){
        self.id = id
